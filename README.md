...
Current staged baseline: **v1.47.9** (v1.47.8 baseline + refreshed sitemap lastmod dates for recently changed Budapest tours and Portugal pages).
...
v1.47.8 synchronizes TouristTrip itinerary structured data with the user-visible Buda, Margaret and Extended route stops across EN/HE/HU, including exact stop count and order. CI now rejects any future mismatch between visible itineraries and schema.\n
